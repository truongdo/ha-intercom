...
| `ringtone_file` | `/var/lib/live-intercom/ringtone.wav` | 16 kHz mono 16-bit PCM WAV to play while ringing; installed from `deploy/ringtone.wav` on every deploy; falls back to the built-in tone if missing |
